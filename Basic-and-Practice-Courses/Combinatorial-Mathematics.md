...
1. **开课信息**：帅天平（2024秋）
2. **推荐等级**：强烈推荐
3. **授课内容**：组合数学，前半部分是高中的排列组合，后半部分生成函数跟离散数学重合
4. **考核方式**：没有期中，签到很频繁但是可以补签，基本上去了就行，考试很简单，期末基本全提前交卷
5. **作业情况**：课本练习题，基本两周一次，有点难度，但是基本上都能搜出来。
6. **成绩情况**：给了93但是期末确实挺简单的，也不知道错哪了。据说高分的人很多
7. **心得体会**：冲就完了，四门课里性价比最高的一门，但是求稳的话可以去隔壁矩阵
